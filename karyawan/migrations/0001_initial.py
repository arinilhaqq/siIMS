    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jabatan', models.CharField(choices=[('owner', 'Owner'), ('akuntan', 'Akuntan'), ('inventori', 'Inventori'), ('service_advisor', 'Service Advisor'), ('teknisi', 'Teknisi')], default='', max_length=15)),
