    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jabatan', models.CharField(choices=[('Admin', 'Admin'), ('Owner', 'Owner'), ('Akuntan', 'Akuntan'), ('Inventori', 'Inventori'), ('Service Advisor', 'Service Advisor'), ('Teknisi', 'Teknisi')], default='', max_length=15)),
